    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        signIn.setOnClickListener(v -> {
            ...
            if (TextUtils.isEmpty(email)) {
                Toast.makeText(LoginActivity.this, "Въведи имейл", Toast.LENGTH_LONG).show();
                return;
            }
            if (TextUtils.isEmpty(password)) {
                Toast.makeText(LoginActivity.this, "Въведи парола", Toast.LENGTH_LONG).show();
                return;
            }
            ...
            firebaseAuth.signInWithEmailAndPassword(email, password)
                    .addOnCompleteListener(task -> {
                        if (task.isSuccessful()) {
                            Toast.makeText(LoginActivity.this, "Влизането е успешно", Toast.LENGTH_LONG).show();
                            ...
                            if (currentUser != null) {
                                ...
                                userRef.addListenerForSingleValueEvent(new ValueEventListener() {
                                    ...
                                    public void onCancelled(@NonNull DatabaseError error) {
                                        Log.e("Firebase", "Грешка в базата данни: " + error.getMessage());
                                    }
                                });
                            }
                            ...
                            Toast.makeText(LoginActivity.this, "Невалиден имейл или парола", Toast.LENGTH_LONG).show();
                            clearAll();
                        }
                    });
        });
