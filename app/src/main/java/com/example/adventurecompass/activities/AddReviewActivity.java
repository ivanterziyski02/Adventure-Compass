            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                FirebaseDatabase.getInstance().getReference("reviews").child(locationId).push()
                        ...
                        .addOnSuccessListener(unused -> {
                            Toast.makeText(AddReviewActivity.this, "Ревюто е записано", Toast.LENGTH_SHORT).show();
                        ...
                        .addOnFailureListener(e ->
                                Toast.makeText(AddReviewActivity.this, "Грешка при запис", Toast.LENGTH_SHORT).show());
            }

            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(AddReviewActivity.this, "Грешка при четене на потребител", Toast.LENGTH_SHORT).show();
            }
        });
    }
