...
import com.example.adventurecompass.utils.ChatManager;
import com.example.adventurecompass.adapters.MessageAdapter;
import com.example.adventurecompass.models.MessageModel;
...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageOtherProfile.setOnClickListener(v -> openUserProfile());
        textOtherName.setOnClickListener(v -> openUserProfile());
    ...
    private void openUserProfile() {
        ...
        intent.putExtra("userId", otherUserId);  // Подай ID на другия потребител
