...
import com.example.adventurecompass.models.LocationModel;
import com.example.adventurecompass.R;
import com.example.adventurecompass.activities.GoogleMapsActivity;
            ...
            Picasso.get().load(imageUrl)
                    ...
                    .into(holder.locationImage, new Callback() {
                        ...
                        public void onSuccess() {
                            Log.d("ImageTest", "Успешно заредени изображения за: " + locationModel.getName());
                        }

                        @Override
                        public void onError(Exception e) {
                            Log.e("ImageTest", "Грешка в зареждането на изображенията за: " + locationModel.getName(), e);
                        }
                    });
        } else {
